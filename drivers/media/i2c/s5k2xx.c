...
static const struct reg_sequence s5k4h7_init[] = {
	{0x0100, 0x0000},
	{0x0000, 0x0012},
	{0x0000, 0x0048},
	{0x0A02, 0x0015},
...
static const struct reg_sequence s5k4h7_mode_3264x2448_regs[] = {
	{0x0100, 0x0000},
	{0x0136, 0x0018},
	{0x0137, 0x0000},
	{0x0305, 0x0006},
...
static const struct s5k2xx_mode s5k4h7_modes[] = {
	{
		.width = 3264,
		.height = 2448,
		.fps = 30,
		...
		.llp = 3688,
		.link_freq_index = S5K2XX_LINK_FREQ_720MHZ_INDEX,
		.regs = s5k4h7_mode_3264x2448_regs,
		.num_regs = ARRAY_SIZE(s5k4h7_mode_3264x2448_regs),
	},
};

static struct s5k2xx_data s5k4h7_data = {
	.model = "s5k4h7",
	.chip_id = 0x487b,
	.modes = s5k4h7_modes,
	.num_modes = ARRAY_SIZE(s5k4h7_modes),
	.init_regs = s5k4h7_init,
	.num_init_regs = ARRAY_SIZE(s5k4h7_init),
};
...
static const struct of_device_id s5k2xx_of_match[] = {
	...
	{ .compatible = "samsung,s5k4h7", &s5k4h7_data},
	{ /* sentinel */ }
};
